...
This example shows the corp ACA runner module in a hub-and-spoke landing-zone pattern: the runner spoke is already connected to the hub through AVNM, and egress is routed to the central Azure Firewall.
